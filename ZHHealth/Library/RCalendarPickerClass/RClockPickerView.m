...
- (void)prepareData{
    ...
    self.themeArray                 = @[UIColorFromHex(0X1abc9c),
                        UIColorFromHex(0X27ae60),
                        UIColorFromHex(0X2980b9),
                        UIColorFromHex(0X2c3e50),
                        UIColorFromHex(0Xf39c12),
                        UIColorFromHex(0Xc0392b),
                        UIColorFromHex(0X7f8c8d),
                        UIColorFromHex(0X8e44ad)];
...
-(void)drawPointer{
    ...
    [self.hoursPointer setBackgroundColor:UIColorFromHex(0xff4081)];
    [self.minutesPointer setBackgroundColor:UIColorFromHex(0xff4081)];
...
-(void)drawClockCenterLayer{
    ...
    self.shapeLayer.fillColor   = UIColorFromHex(0Xf5f5f5).CGColor;
    self.shapeLayer.strokeColor = UIColorFromHex(0xff4081).CGColor;
...
-(void)drawClockLayer{
    ...
    shapeLayer.fillColor       = UIColorFromHex(0Xf5f5f5).CGColor;
    shapeLayer.strokeColor     = UIColorFromHex(0Xf5f5f5).CGColor;
...
-(UIView *)headerView{
    if (!_headerView) {
        ...
        [_headerView setBackgroundColor:UIColorFromHex(0xff4081)];
    }
    return _headerView;
}
-(UIView *)clockView{
    if (!_clockView) {
        ...
        [_clockView setBackgroundColor:UIColorFromHex(0xffffff)];
    }
    return _clockView;
}
...
-(UILabel *)hoursLabel{
    if (!_hoursLabel) {
        ...
        [_hoursLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)minutesLabel{
    if (!_minutesLabel) {
        ...
        [_minutesLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)semicolonLabel{
    if (!_semicolonLabel) {
        ...
        [_semicolonLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)morningLabel{
    if (!_morningLabel) {
        ...
        [_morningLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)afternoonLabel{
    if (!_afternoonLabel) {
        ...
        [_afternoonLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UIButton *)cancelButton {
    if(!_cancelButton){
        ...
        [_cancelButton setTitleColor:UIColorFromHex(0x898989) forState:UIControlStateNormal];
...
-(UIButton *)okButton {
    if(!_okButton){
        ...
        [_okButton setTitleColor:UIColorFromHex(0x898989) forState:UIControlStateNormal];
