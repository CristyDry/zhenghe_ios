...
-(UIView *)bgView{
    ...
    if (!_bgView) {
        ...
        [_bgView setBackgroundColor:UIColorFromHex(0x295DC0)];
        _bgView.hidden = YES;
...
- (UILabel *)znDayLabel
{
    if (!_znDayLabel) {
        ...
        [_znDayLabel setTextColor:UIColorFromHex(0xB3B3B3)];
...
- (UILabel *)dataSourceLabel
{
    if (!_dataSourceLabel) {
        ...
        [_dataSourceLabel setTextColor:UIColorFromHex(0xffffff)];
