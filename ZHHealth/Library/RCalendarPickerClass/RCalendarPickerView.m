...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        cell.dayLabelTextColor = UIColorFromHex(0x6f6f6f);
        cell.znDay = nil;
        ...
        if (i < firstWeekday) {
            ...
            cell.dayLabelTextColor = UIColorFromHex(0x5d5d5d);
            //this month 当前月 当前天
            ...
            if (day == [DateHelper day:[NSDate date]] && isThisMonth && isThisYear) {
                cell.isToDay = YES;
                cell.dayLabelTextColor = UIColorFromHex(0xffffff);
            }
            //选择的天
...
-(UIView *)headerView{
    if (!_headerView) {
        ...
        [_headerView setBackgroundColor:UIColorFromHex(0x295DC0)];
    }
    return _headerView;
}
-(UILabel *)weekLabel{
    if (!_weekLabel) {
        ...
        [_weekLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)monthLabel{
    if (!_monthLabel) {
        ...
        [_monthLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)dayLabel{
    if (!_dayLabel) {
        ...
        [_dayLabel setFont:[UIFont boldSystemFontOfSize:90]];
        [_dayLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)yearLabel{
    if (!_yearLabel) {
        ...
        [_yearLabel setTextColor:UIColorFromHex(0xffffff)];
...
-(UILabel *)groundColourMonthLabel{
    if (!_groundColourMonthLabel) {
        ...
        [_groundColourMonthLabel setTextColor:UIColorFromHex(0x000000)];
...
-(UIButton *)cancelButton {
    if(!_cancelButton){
        ...
        [_cancelButton setTitle:LANGUAGE(@"取消") forState:UIControlStateNormal];
...
-(UIButton *)okButton {
    if(!_okButton){
        ...
        [_okButton setTitle:LANGUAGE(@"确定") forState:UIControlStateNormal];
